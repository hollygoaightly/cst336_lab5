...
app.get("/", async function(req, res){
    let apiUrl = `https://api.unsplash.com/photos/random/?client_id=d39r-iOFdmE1vmuAdK4M1akjN8JvCVrrkdCaQySyi0I&featured=true&orientation=landscape`
...
app.get("/search", async function(req, res){
    ...
    let apiUrl = `https://api.unsplash.com/photos/random/?count=9&client_id=d39r-iOFdmE1vmuAdK4M1akjN8JvCVrrkdCaQySyi0I&featured=true&orientation=landscape&query=${keyword}`;
    let response = await fetch(apiUrl);
    let data = await response.json();
...
// for the favorites page, this function grabs distinct keywords saved corresponding to the images
